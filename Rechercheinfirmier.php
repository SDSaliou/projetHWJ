...
<body>
	...
	<h1>Search</h1>
	<form action="Rechercheinfirmier.php" method="post">
    ...
    if ($select=="nom"){
        $recherche=('SELECT * from personnels WHERE personnel_service_id=3 AND personnel_name="'.$idsearch.'"');
    }elseif ($select=="code"){
        $recherche=('SELECT * from personnels WHERE personnel_service_id=3  AND personnel_code='.$idsearch);
    }    
