...
<body>
    ...
    <form action="modifierinfirmier.php" method="post">
    ...
    $query = $conn->query('SELECT * from personnels WHERE personnel_service_id=3 AND personnel_id='.$idmod );
    while ($rowData=$query->fetch_assoc()){
        echo '
        <form action="traitmodinf.php" method="post">
    <fieldset>
        ...
        <p><label for="dat">Horaire</label>:<input id="dat" name ="horaire" type="date" value="'.$rowData["horaire"].'"></p>
        </fieldset>
     <input type="submit" >
     </form>';
    }
